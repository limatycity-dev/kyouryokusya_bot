...
exports.profileSetupCommand = void 0;
const discord_js_1 = require("discord.js");
exports.profileSetupCommand = {
...
`;
        // ===== MBTI セレクトメニュー =====
        const mbtiMenu = new discord_js_1.ActionRowBuilder().addComponents(new discord_js_1.StringSelectMenuBuilder()
        ...
        // ===== デバイス セレクトメニュー =====
        const deviceMenu = new discord_js_1.ActionRowBuilder().addComponents(new discord_js_1.StringSelectMenuBuilder()
