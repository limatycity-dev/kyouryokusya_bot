...
exports.handleRankingButton = handleRankingButton;
const discord_js_1 = require("discord.js");
const updateRealtimeRanking_1 = require("../update/updateRealtimeRanking");
const updateWeeklyRanking_1 = require("../update/updateWeeklyRanking");
async function handleRankingButton(interaction) {
    try {
        ...
        if (interaction.customId === "ranking_refresh") {
            ...
            const success = await (0, updateRealtimeRanking_1.updateRealtimeRanking)(channel);
            if (success) {
                return interaction.reply({
        ...
        if (interaction.customId === "ranking_weekly") {
            ...
            const success = await (0, updateWeeklyRanking_1.updateWeeklyRanking)(channel);
            if (success) {
                return interaction.reply({
